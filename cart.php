              ...
              <div class="panel-body">
                ...
                <form class="form-horizontal">
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                  		<input type="text" class="form-control" id="input-address-1" placeholder="Address 1" value="php getaddress1()" name="address_1" readonly>
                  	</div>
                  </div>
                  <div class="form-group required">
                    <label class="col-sm-2 control-label">Address Line 2</label>
                    <div class="col-sm-10">
                  		<input type="text" class="form-control" id="input-address-2" placeholder="Address 2" value="php getaddress2()" name="address_2" readonly>
                  	</div>
                  </div>
                  <div class="form-group required">
                    <label class="col-sm-2 control-label">State</label>
                    <div class="col-sm-10">
                  		<input type="text" class="form-control" id="state" placeholder="state" value="php state()" name="state" readonly>
                  	</div>
                  </div>
                  <div class="form-group required">
                    <label class="col-sm-2 control-label">City</label>
                    <div class="col-sm-10">
                  		<input type="text" class="form-control" id="pin" placeholder="city" value="php city()" name="city" readonly>
                  	</div>
                  </div>
                  <div class="form-group required">
                    <label class="col-sm-2 control-label">Pin</label>
                    <div class="col-sm-10">
                  		<input type="text" class="form-control" id="city" placeholder="pin" value="php pin()" name="pin" readonly>
                  	</div>
                  </div>
