...
insert  into `customers`(`uid`,`Fname`,`Lname`,`email`,`contact_no`,`address1`,`address2`,`city`,`state`,`pin`,`password`) values (1,'dasd','gasg','agsd@dad.asf','1111111111','fsfdg','sfdgdf','dfgdfsg','dfgdfsgd','111111','Aaaa11111'),(2,'Sami','Syed','ka.boom.tm@gmail.com','8692880768','E-711,Lok Sarita,','Marol Miltery Road,Andheri(EAST)','Mumbai','Maharashtra','400059','Assasin712');
